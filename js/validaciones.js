...
var nombreOperario = document.getElementById("nombreOperario");
var resO = document.getElementsByName("ResponsableO");
var responsableO;
...
function validaciones() {
  ...
  // Numero de la Orden
  if (noOrden.value == null || noOrden.value == "") {
    document.getElementById("headermensaje").style.background = "#ff3c37";
    document.getElementById("titulomensaje").innerHTML = "ERROR";
    document.getElementById("mensaje").innerHTML =
  ...
  if (cantidadLote.value == null || cantidadLote.value == "") {
    ...
    document.getElementById("titulomensaje").innerHTML = "ERROR";
    document.getElementById("mensaje").innerHTML =
      "Ingrese la cantidad del lote (Solo se aceptan números)";
    return false;
  }
  //Numero de Muestra
